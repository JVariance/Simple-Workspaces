/*
	Source: https://github.com/ankurrsinghal/svelte-legos/blob/master/src/lib/actions/portalAction/index.ts
	License: MIT
*/
...
export function portalAction<T extends HTMLElement>(
	element: T,
	{ target, enabled }: { enabled?: boolean; target: HTMLElement | string } = {
		enabled: false,
		target: "body",
	}
) {
